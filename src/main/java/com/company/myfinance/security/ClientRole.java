...
public interface ClientRole {
	@MenuPolicy(menuIds = {"BankAccount.browse", "Transaction_.browse", "Type_.browse", "Client.browse", "MyFinanceScreen"})
	@ScreenPolicy(screenIds = {"BankAccount.browse", "Transaction_.browse", "BankAccount.edit", "LoginScreen", "MainScreen", "Transaction_.edit", "Type_.edit", "Type_.browse", "Client.browse", "MyFinanceScreen", "ui_AddConditionScreen", "ui_GroupFilterCondition.edit", "ui_JpqlFilterCondition.edit", "ui_PropertyFilterCondition.edit", "ui_FilterConfigurationModel.fragment", "sec_RoleFilterFragment"})
	void screens();
